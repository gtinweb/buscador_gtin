...
Pues la idea de este script (ni programa lo llamaría yo) es precisamente afinar eso. Vale, si no empieza por 84 pues asumiremos que no se ha hecho en España (sería raro que se hiciera en españa para venderse en España y le pusieran un código de barras del extranjero). Y si empieza por 84 pues ya veremos qué se puede averiguar.... 

ESO SI, SIEMPRE SIN GARANTIA NINGUNA. 

No nos inventamos nada, los datos los sacamos de bases de datos públicas, y tal y como está internet, yo no me fiaría de nada ni de nadie. De hecho si lo subo aquí es para no tener que meterme un servidor en casa, o sea, que esto lo hago PA MÍ. Si te resulta útil, pues vale, y si no, pues vale. No quiero quejas. 
